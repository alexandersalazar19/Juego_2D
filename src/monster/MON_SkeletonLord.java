...
public class MON_SkeletonLord extends Entity{
    GamePanel gp;
    public static final String monName="Rey Esqueleto";
    ...
    public void getAttackImage(){
        ...
        if(!inRage){
            ...
            attackUp2=setup("/monster/skeletonlord_attack_up_1",gp.tileSize*i,gp.tileSize*i*2);
        ...
        if(inRage){
            ...
            attackUp2=setup("/monster/skeletonlord_phase2_attack_up_1",gp.tileSize*i,gp.tileSize*i*2);
