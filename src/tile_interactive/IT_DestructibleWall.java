...
public class IT_DestructibleWall extends InteractiveTile{
    ...
    public void playSE(){gp.playSE(20);}

    public InteractiveTile getDestroyedForm(){InteractiveTile tile=null; return tile;}

    public Color getParticleColor(){Color color=new Color(65,65,65); return color;}
    ...
    public void checkDrop(){
        ...
        if(i<60) dropItem(new OBJ_Coin_Bronze(gp));
    }
}