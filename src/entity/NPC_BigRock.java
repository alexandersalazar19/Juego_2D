...
public class NPC_BigRock extends Entity{
    public static final String npcName="Roca Grande";
    ...
    public void setDialogue(){
        dialogues[0][0]="Es una roca gigante.";
    }
    ...
    public void detectPlate(){
        ...
        //verificar si la placa tiene una roca encima
        ...
        //contar cuantas rocas hay con placas
        for(int i=0;i<rockList.size();i++){
            if(rockList.get(i).linkedEntity!=null) count++;
        }

        //verificar si todas las placas tienen una roca encima
