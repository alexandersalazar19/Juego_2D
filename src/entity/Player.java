...
//        worldY=gp.tileSize*12;
    ...
    public void update(){
        if(attacking){
            ...
            //REVISAR COLISION CON OBJETO
            int objIndex=gp.cChecker.checkObject(this,true);
            pickUpObject(objIndex);

            //REVISAR COLISION CON NPC
            int npcIndex=gp.cChecker.checkEntity(this,gp.npc);
            interactNPC(npcIndex);

            //REVISAR COLISION CON MOUNTRUOS
        ...
        if(gp.keyH.shotKeyPressed && !projectile.alive && shotAvailableCounter==30 && projectile.haveResource(this)){
            //COORDENADAS, DIRECCION Y USUARIO POR DEFECTO
            projectile.set(worldX,worldY,direction,true,this);

            //QUITAR EL COSTO DE USO (MANA, BALAS, ETC)
            projectile.subtractResource(this);

            //AÑADIRLO A LA LISTA BUSCANDO ESPACIOS NULOS
    ...
    public void attacking(){
        ...
        if(spriteCounter>5 && spriteCounter<=25){
            ...
            //guardar la posicion original del jugador
            int currentWorldX=worldX;
            int currentWorldY=worldY;
            int solidAreaWidth=solidArea.width;
            int solidAreaHeight=solidArea.height;

            //ajustar la posicion del jugador para atacar
            switch(direction){
            ...
            //el attackArea se convierte en la solidArea
            solidArea.width=attackArea.width;
            solidArea.height=attackArea.height;

            //Revisar si hay colision con un mounstruo en la nueva posicion de solidArea
            int monsterIndex=gp.cChecker.checkEntity(this,gp.monster);
            ...
            //Despues de revisar si hay colision, restaurar los datos originales
    ...
    public void pickUpObject(int i){
        if(i!=999){
            ...
            if(gp.obj[gp.currentMap][i].type==type_pickUpOnly){
                ...
                //ITEMS PARA EL INVENTARIO
                String text;
                if(canObtainItem(gp.obj[gp.currentMap][i])){
                    gp.playSE(1);
                    text="Conseguiste "+gp.obj[gp.currentMap][i].name;
                }else{
                    text="Tu inventario está lleno";
                }
    ...
    public void damageInteractiveTile(int i){
        if(i!=999 && gp.iTile[gp.currentMap][i].desctructible && gp.iTile[gp.currentMap][i].isCorrectItem(this) && !gp.iTile[gp.currentMap][i].invincible){
